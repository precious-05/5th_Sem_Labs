...
function initProjectModals() {
    ...
    const projects = {
        ...
        2: {
            ...
            links: {
                kaggle: "https://www.kaggle.com/code/alinaliaquat/eda-on-monthly-revenue-of-us-natural-resources"
            }
        },
        4: {
            title: "Thyroid Cancer EDA",
            description: "An EDA project for thyroid cancer analysis using patient demographic data, medical history, and diagnostic test results. This ongoing project aims to develop an accurate diagnostic tool to assist healthcare professionals in early detection and risk assessment.",
            tech: ["Python", "Pandas", "NumPy", "Seaborn, Matplotlib"],
            images: ["images/tsh3.png"],
            links: {
                kaggle: "https://www.kaggle.com/code/alinaliaquat/detailed-eda-thyroid-cancer-risk"
            }
        },
        5: {
            title: "Thyroid Cancer Diagnosis",
            description: "A machine learning classification project for thyroid cancer diagnosis using patient clinical data. This project implements multiple classification algorithms including Random Forest, SVM, and Logistic Regression to achieve 83% accuracy in predicting thyroid cancer. Features include comprehensive data preprocessing, feature engineering, and model evaluation with cross-validation.",
            tech: ["Python", "Scikit-learn", "Pandas", "NumPy", "Matplotlib", "Seaborn"],
            images: ["images/tsh.png"],
            links: {
                kaggle: "https://www.kaggle.com/code/alinaliaquat/thyroid-cancer-dagnosis-83-accuracy"
            }
        }
    };
...
// Contact form functionality - NETLIFY FORMS SOLUTION
function initContactForm() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            // Netlify automatically processes forms with 'netlify' attribute
            // We'll use the standard form submission
            ...
            if (response.ok) {
                ...
                // Netlify will automatically send you an email
            ...
            window.location.href = `mailto:lnliaquat@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
            showToast('Opening email client... Please send the pre-filled email!');
            contactForm.reset();
        } finally {
            // Reset button
...
function initResumeDownload() {
    ...
    resumeBtn.addEventListener('click', function(e) {
        ...
        const resumeUrl = 'Alina_Liaquat_Resume.pdf';
        ...
        link.addEventListener('click', function(e) {
            ...
            switch(certificateTitle) {
                ...
                case 'Simple Linear Regression':
                    certificateUrl = 'Linear_Regression_Certificate_Coursera.pdf';
                    break;
                default:
                    certificateUrl = 'Linear_Regression_Certificate_Coursera.pdf';
            }
