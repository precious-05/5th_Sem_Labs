...
function initProjectModals() {
    ...
    const projects = {
        ...
        4: {
            ...
            tech: ["Python", "Scikit-learn", "TensorFlow", "Pandas", "NumPy", "Seaborn"],
                    ...
                    <div class="carousel-container">
                        ${project.images.map(img => `
                            <div class="carousel-slide">
                                <img src="${img}" alt="${project.title}" onerror="this.src='images/project-placeholder.jpg'">
                            </div>
                        `).join('')}
                    </div>
...
function initContactForm() {
    ...
    function simulateFormSubmission(name, email, message) {
        ...
        // Simulate API call to Formspree or similar service
        setTimeout(() => {
        ...
        link.addEventListener('click', function(e) {
            ...
            switch(certificateTitle) {
                case 'Google Prompting Essentials':
                    certificateUrl = 'certificates/Google_Prompting_Essentials_Certificate.pdf';
                    break;
                case 'Google Advanced Data Analytics':
                    certificateUrl = 'certificates/Google_Advanced_Data_Analytics_Certificate.pdf';
                    break;
                default:
