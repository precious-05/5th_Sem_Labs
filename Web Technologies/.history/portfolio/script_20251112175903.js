...
function initProjectModals() {
    ...
    const projects = {
        ...
        4: {
            ...
            description: "An EDA project for thyroid cancer analysis using patient demographic data, medical history, and diagnostic test results. This ongoing project aims to develop an accurate diagnostic tool to assist healthcare professionals in early detection and risk assessment. Features include data preprocessing, feature engineering, and multiple ML model comparisons.",
