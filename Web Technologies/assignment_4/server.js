...
app.get("/", (req,res) =>    // Callback: (req, res) => {}
    {
...
Ye ek HTTP endpoint / route hai

Method: GET
URL Path: / (home page)

Jab user browser me likhe:  http://localhost:3000/
To Express ye file send karega: res.sendFile(path.join(__dirname, "public", "index.html"));
...
// This line says : Turn ON the Server
