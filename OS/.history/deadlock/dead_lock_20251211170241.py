...
body {
  background: linear-gradient(135deg, #f3e8ff 0%, #ece0ff 100%);
...
/* Header styling */
.custom-header {
    background: linear-gradient(135deg, #e9ddff 0%, #d8c7ff 100%) !important;
    border-radius: 16px;
    padding: 25px 30px !important;
    margin-left: 300px;
    margin-bottom: 20px;
    box-shadow: 0 8px 30px rgba(150, 120, 255, 0.25);
    text-align: center;
    color: #4b3a7a;
    font-weight: 600;
}
