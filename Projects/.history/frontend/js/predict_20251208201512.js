...
// Show Form Help
// predict.js mein help section update karo
function showFormHelp() {
    const helpContent = `
        <h4>Form Help Guide</h4>
        <p><strong>Thyroid Cancer Risk Score:</strong></p>
        <ul>
            <li><strong>0 - Low Risk:</strong> Minimal indicators (108,388 cases in dataset)</li>
            <li><strong>1 - Moderate Risk:</strong> Some concerning factors (72,400 cases)</li>
            <li><strong>2 - High Risk:</strong> Multiple risk factors (31,903 cases)</li>
        </ul>
        <p><em>Note: Based on your dataset analysis with 212,691 records</em></p>
