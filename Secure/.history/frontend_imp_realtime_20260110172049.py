        ...
        <div class="modern-stat-card">
            <div class="modern-stat-content">
                <div class="modern-stat-icon-wrapper">
                    <div class="modern-stat-icon">{icon}</div>
                </div>
                <div class="modern-stat-number">{value}</div>
                <div class="modern-stat-label">{label}</div>
            </div>
            <div class="modern-stat-decoration"></div>
        </div>
        """, unsafe_allow_html=True)
...
def render_feature_card(icon, title, description, col):
    ...
    with col:
        ...
        <div class="modern-feature-card">
            <div class="modern-feature-icon-wrapper">
                <div class="modern-feature-icon">{icon}</div>
            </div>
            <div class="modern-feature-content">
                <h3 class="modern-feature-title">{title}</h3>
                <p class="modern-feature-desc">{description}</p>
            </div>
...
def render_metric_box(label, value, col):
    """Render a modern metric box"""
    with col:
        st.markdown(f"""
        <div class="modern-metric-box">
            <div class="modern-metric-label">{label}</div>
            <div class="modern-metric-value">{value}</div>
            <div class="modern-metric-progress"></div>
        </div>
        """, unsafe_allow_html=True)

def render_glass_card(title, content=None):
    """Render a modern card without glassmorphism"""
    st.markdown(f"""
    <div class="modern-content-card">
        <div class="modern-card-header">
            <div class="modern-card-title-wrapper">
                <h2 class="modern-card-title">{title}</h2>
                <div class="modern-card-accent"></div>
            </div>
        </div>
        <div class="modern-card-body">{content if content else ""}</div>
    </div>
    """, unsafe_allow_html=True)
