...
def render_hero_section():
    ...
    st.markdown('<h1 class="animated-heading">💊 MediNomix </h1>', unsafe_allow_html=True)
st.markdown('<p class="animated-subheading">Your subtitle with animation</p>', unsafe_allow_html=True)
