...
# Purple Theme Color Scheme with Gradients
COLORS = {
    ...
    'purple': '#8B5CF6',            # Same as primary
    'purple_light': '#A78BFA',      # Light purple
    'purple_dark': '#7C3AED',       # Dark purple
    'yellow': '#FBBF24',
    'pink': '#EC4899',
    'dark': '#1F2937',
    'light': '#FFFFFF',
    'card_bg': '#FFFFFF',
    'sidebar_bg': '#FAF5FF',        # Light purple background
    'border': '#E5E7EB',
    'text_primary': '#111827',
    ...
    # GRADIENTS - Purple Focus
    'gradient_primary': 'linear-gradient(135deg, #8B5CF6 0%, #3B82F6 100%)',          # Purple to Blue
    'gradient_secondary': 'linear-gradient(135deg, #8B5CF6 0%, #EC4899 100%)',        # Purple to Pink
    'gradient_success': 'linear-gradient(135deg, #10B981 0%, #8B5CF6 100%)',          # Green to Purple
    'gradient_warning': 'linear-gradient(135deg, #F59E0B 0%, #8B5CF6 100%)',          # Amber to Purple
    'gradient_danger': 'linear-gradient(135deg, #EF4444 0%, #8B5CF6 100%)',           # Red to Purple
    'gradient_purple': 'linear-gradient(135deg, #8B5CF6 0%, #A78BFA 100%)',           # Purple gradient
    'gradient_dark': 'linear-gradient(135deg, #1F2937 0%, #8B5CF6 100%)',             # Dark to Purple
    'gradient_medical': 'linear-gradient(135deg, #8B5CF6 0%, #3B82F6 50%, #0EA5E9 100%)',  # Purple medical gradient
    'gradient_sidebar': 'linear-gradient(180deg, #FFFFFF 0%, #FAF5FF 100%)',          # Light purple sidebar
}
# ================================
