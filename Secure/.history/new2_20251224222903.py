...
def display_realtime_metrics():
    """Simple function to display real-time metrics"""
    metrics = st.session_state.realtime_metrics or {}
    
    # Use Streamlit's built-in columns instead of HTML
    ...
    with col3:
        st.metric(
            ...
            help="Average risk score across all pairs"
        )
    
    with col4:
        st.metric(
            label="Connected Clients", 
            value=metrics.get('connected_clients', 0),
