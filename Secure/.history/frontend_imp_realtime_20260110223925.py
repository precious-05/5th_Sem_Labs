...
def main():
    ...
    # Navigation Tabs with beautiful icons
    tab1, tab2, tab3, tab4 = st.tabs([
        " <i class='fas fa-home' style='color:#8B5CF6;'></i> Home", 
        " <i class='fas fa-search' style='color:#8B5CF6;'></i> Drug Analysis", 
        " <i class='fas fa-chart-line' style='color:#8B5CF6;'></i> Analytics", 
        " <i class='fas fa-bolt' style='color:#8B5CF6;'></i> Real-Time"
    ])
    ...
    with tab1:
        ...
        features = [
            ...
            {"icon": "<i class='fas fa-brain' style='color:#EC4899;'></i>", "title": "Analysis", "desc": "Our system analyzes spelling, phonetic, and therapeutic similarities"},
        ...
        render_glass_card("<i class='fas fa-handshake' style='color:#8B5CF6; margin-right:10px;'></i>Trusted by Healthcare Professionals")
    ...
    # Render Footer with beautiful icons
    st.markdown(f"""
    <div class="neon-footer">
        <div style="max-width: 600px; margin: 0 auto; padding: 0 20px;">
            <div style="margin-bottom: 24px;">
