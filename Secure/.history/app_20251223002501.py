...
COLORS = {
    "primary": "#FF6B6B",        # Coral (Same)
    "primary_light": "#FF8E8E",
    "primary_dark": "#FF4757",
    "secondary": "#10B981",      # Emerald (Same)
    "accent": "#8B5CF6",         # Purple (Changed from Fuchsia)
    "accent_pink": "#7C3AED",    # Deep Purple (Was #FF6B9D pink)
    "success": "#10B981",        # Emerald (Same)
    "warning": "#FF9F43",        # Coral (Same)
    "danger": "#7C3AED",         # Purple (Was #C026D3 fuchsia)
    "dark": "#1E1B4B",           # Dark Purple (Same)
    "light": "#F0FDF4",          # Emerald (Same)
    "surface": "#FFFFFF",
    "gray": "#8B5CF6",           # Purple (Was #A78BFA light purple)
    "gray_light": "#F5F6FA",     # Coral (Same)
    "border": "#8B5CF6",         # Purple (Was #FFE8E8 coral)
}
