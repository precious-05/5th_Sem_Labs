...
COLORS = {
    "primary": "#B8B0FF",        # Soft Lavender
    "primary_light": "#D4CDFF",
    "primary_dark": "#9A8EFF",
    "secondary": "#FFB8E6",      # Baby Pink
    "accent": "#A3D9FF",         # Sky Blue
    "accent_pink": "#FF9EBD",    # Blush Pink
    "success": "#A0E7C0",        # Mint Green
    "warning": "#FFD6A5",        # Peach
    "danger": "#FFADAD",         # Salmon
    "dark": "#6D6875",           # Dusty Purple
    "light": "#FFFAFA",          # Rose White
    "surface": "#FFFBFF",        # Lavender White
    "gray": "#C9B6D6",
    "gray_light": "#F7F2FF",
    "border": "#E8DEFF",
}
