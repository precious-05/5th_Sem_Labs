...
COLORS = {
    ...
    # Categorical palette for charts (per IBM Design System[citation:1])
    "cat_purple": "#7C3AED",
    "cat_cyan": "#38BDF8",
    "cat_teal": "#0D9488",
    "cat_magenta": "#DB2777",
...
def create_heatmap_chart():
    ...
    # Professional sequential color scale (avoiding rainbow pitfalls)[citation:10]
    colorscale = [
    ...
    fig.update_layout(
        ...
        xaxis=dict(
            ...
            linewidth=1,
            mirror=True,
            side="top"  # Move x-axis labels to top for better readability
        ),
        yaxis=dict(
            tickfont=dict(size=10, family="'Inter', sans-serif"),
            gridcolor='rgba(0,0,0,0.03)',
            ...
            linewidth=1,
            mirror=True,
            autorange="reversed"  # Keep diagonal from top-left to bottom-right
        ),
        hoverlabel=dict(
            bgcolor="white",
            font_size=12,
