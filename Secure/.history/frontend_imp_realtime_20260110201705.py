...
def render_sidebar():
    ...
    with st.sidebar:
                ...
                if data.get('status') == 'healthy':
                    ...
                    with col1:
                        ...
                        <div class="metric-card">
                            <div class="metric-icon-wrapper" style="background: #ECFDF5; border: 1px solid #D1FAE5;">
                                <i class="fas fa-pills metric-icon" style="color: #10B981;"></i>
                            </div>
                    ...
                    with col2:
                        st.markdown(f"""
                        <div class="metric-card">
                            <div class="metric-icon-wrapper" style="background: #F0F9FF; border: 1px solid #E0F2FE;">
                                <i class="fas fa-chart-bar metric-icon" style="color: #0EA5E9;"></i>
                            </div>
        ...
        <div class="sidebar-card">
            <div class="sidebar-card-header">
                <div class="sidebar-icon-wrapper" style="background: #F3E8FF; border: 1px solid #E5D8FA;">
                    <i class="fas fa-link sidebar-header-icon" style="color: #7C3AED;"></i>
                </div>
        ...
        <div class="sidebar-card">
            <div class="sidebar-card-header">
                <div class="sidebar-icon-wrapper" style="background: #FEF3C7; border: 1px solid #FDE68A;">
                    <i class="fas fa-exclamation-triangle sidebar-header-icon" style="color: #F59E0B;"></i>
                </div>
        ...
        risk_levels = [
            ("Critical", "≥75%", "Immediate attention required", "#EF4444", "#FEE2E2", "#FECACA"),
            ("High", "50-74%", "Review and verify", "#F59E0B", "#FEF3C7", "#FDE68A"),
            ("Medium", "25-49%", "Monitor closely", "#8B5CF6", "#F3E8FF", "#E5D8FA"),
            ("Low", "<25%", "Low priority", "#10B981", "#ECFDF5", "#D1FAE5")
        ]
        
        for name, score, desc, color, bg_color, border_color in risk_levels:
            st.markdown(f"""
            <div class="risk-item">
