...
COLORS = {
    "primary": "#10B981",        # Emerald (Professional)
    "primary_light": "#34D399",
    "primary_dark": "#059669",
    "secondary": "#8B5CF6",      # Fuchsia (Tech vibe)
    "accent": "#FF9F43",         # Coral (Warmth)
    "accent_pink": "#F472B6",    # Citrus (Soft)
    "success": "#10B981",        # Emerald
    "warning": "#EAB308",        # Citrus
    "danger": "#FF4757",         # Coral
    "dark": "#1F2937",           # Emerald
    "light": "#FDF4FF",          # Fuchsia
    "surface": "#FFFFFF",
    "gray": "#9CA3AF",           # Emerald
    "gray_light": "#FAF5FF",     # Fuchsia
    "border": "#D1FAE5",         # Emerald
}
