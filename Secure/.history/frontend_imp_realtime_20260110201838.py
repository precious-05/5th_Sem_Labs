...
<div style="text-align: center; margin-bottom: 24px;">
    <div class="medinomia-card">
        <div class="card-icon">
            <i class="fas fa-prescription-bottle-alt"></i>
        </div>
        <h2 style="margin: 0; color: #7C3AED !important; font-weight: 800; font-size: 24px; margin-bottom: 4px;">
            MediNomix
        </h2>
        <p style="color: #6B7280; margin: 0; font-size: 12px; font-weight: 600;">
...
""", unsafe_allow_html=True)
        ...
        st.markdown('<div class="glass-card"><div class="modern-guide-title"><h2>System Status</h2></div></div>', unsafe_allow_html=True)
        ...
        # Quick Links
        st.markdown('<div class="glass-card"><div class="modern-guide-title"><h2>Quick Links</h2></div></div>', unsafe_allow_html=True)
