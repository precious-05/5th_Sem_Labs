...
@keyframes slideshow {{
    0%, 33% {{
        background-image: 
            linear-gradient(135deg, rgba(139, 92, 246, 0.8) 0%, rgba(124, 58, 237, 0.85) 100%),
            url('https://images.unsplash.com/photo-1585435557343-3b0920313a7b?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80') !important;
    }}
    34%, 66% {{
        background-image: 
            linear-gradient(135deg, rgba(139, 92, 246, 0.8) 0%, rgba(124, 58, 237, 0.85) 100%),
            url('https://images.unsplash.com/photo-1579684385127-1ef15d508118?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80') !important;
    }}
    67%, 100% {{
        background-image: 
            linear-gradient(135deg, rgba(139, 92, 246, 0.8) 0%, rgba(124, 58, 237, 0.85) 100%),
            url('https://images.unsplash.com/photo-1559757148-5c350d0d3c56?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80') !important;
    }}
}}
...
.hero-section::before {{
    ...
    animation: slideshow 18s ease-in-out infinite !important;
}}
