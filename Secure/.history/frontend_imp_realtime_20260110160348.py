...
COLORS = {
    ...
    'primary_hover': '#7C3AED',  # Darker purple for hover
    'secondary': '#10B981',  # Keeping success green as secondary
    'success': '#10B981',
    'warning': '#F59E0B',
    'danger': '#EF4444',
    'info': '#0EA5E9',
    'purple': '#8B5CF6',  # Same as primary for consistency
    'yellow': '#FBBF24',
    'pink': '#EC4899',
    'dark': '#1F2937',
    'light': '#FFFFFF',
    'card_bg': '#FFFFFF',
    'sidebar_bg': '#F5F3FF',  # Light purple background
    'border': '#E5E7EB',
    'text_primary': '#1F2937',  # High contrast dark gray
    'text_secondary': '#4B5563',
    'text_muted': '#9CA3AF',
    'shadow': 'rgba(139, 92, 246, 0.15)',  # Purple shadow
    'shadow_hover': 'rgba(139, 92, 246, 0.25)',
    # Updated Gradients with 3 colors for modern look
    'gradient_primary': 'linear-gradient(135deg, #8B5CF6 0%, #7C3AED 50%, #6D28D9 100%)',
    'gradient_secondary': 'linear-gradient(135deg, #10B981 0%, #0EA5E9 50%, #8B5CF6 100%)',
    'gradient_success': 'linear-gradient(135deg, #10B981 0%, #34D399 50%, #0EA5E9 100%)',
    'gradient_warning': 'linear-gradient(135deg, #F59E0B 0%, #FBBF24 50%, #FCD34D 100%)',
    'gradient_danger': 'linear-gradient(135deg, #EF4444 0%, #F87171 50%, #FCA5A5 100%)',
    'gradient_purple': 'linear-gradient(135deg, #8B5CF6 0%, #7C3AED 50%, #EC4899 100%)',
    'gradient_dark': 'linear-gradient(135deg, #1F2937 0%, #374151 50%, #4B5563 100%)',
    'gradient_medical': 'linear-gradient(135deg, #8B5CF6 0%, #7C3AED 50%, #10B981 100%)'
}
# ================================
