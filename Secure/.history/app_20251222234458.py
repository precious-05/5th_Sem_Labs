...
# Fix 1: REMOVE the duplicate HTML header that was displaying as text
# Fix 2: Use only ONE header with proper st.markdown()

# Modern Header with Base64 Icons - FIXED VERSION
st.markdown(f"""
...
# Modern Footer - FIXED: Now properly using st.markdown with unsafe_allow_html=True
st.markdown(f"""
<style>
.medinomix-footer {{
    text-align: center;
