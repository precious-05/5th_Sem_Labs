...
def render_guide_section():
    """Render modern user guide section with Font Awesome icons and theme colors"""
    ...
    # Main Guide Card with gradient background
    st.markdown("""
    <div style="
        background: linear-gradient(135deg, 
        ...
        <div style="position: relative; z-index: 1;">
            ...
            <div style="text-align: center; margin-bottom: 36px;">
                ...
                <p style="
                    ...
                    line-height: 1.6;
                ">
                    Follow these steps to effectively use MediNomix for medication safety analysis
                </p>
            </div>
        ...
        <div style="flex: 1;">
            ...
            ">
                ...
                <li style="
                    ...
                    font-weight: 500;
                ">
                    Enter any medication name (brand or generic)
                </li>
                <li style="
                    margin-bottom: 0;
                    padding-left: 8px;
                ...
                ">
                    Click <span style="
                        ...
                        font-size: 14px;
                        margin: 0 4px;
                    ">Analyze Drug</span> to start AI analysis
                </li>
            </ul>
        </div>
    </div>
        ...
        <div style="flex: 1;">
            ...
            ">
                <li style="
                    ...
                    font-weight: 500;
                ">
                    View all similar drugs with confusion risks
                </li>
                <li style="
                    margin-bottom: 10px;
                    padding-left: 8px;
                ...
                <li style="
                    ...
                    font-weight: 500;
                ">
                    Examine detailed similarity metrics and AI insights
                </li>
            </ul>
        </div>
    </div>
            ...
            ">
                ...
                ">
                    Check <span style="
                        ...
                        border-radius: 6px;
                        margin: 0 4px;
                    "><i class="fas fa-chart-line" style="margin-right: 4px;"></i> Analytics</span> tab for overall statistics
                </li>
                <li style="
                    margin-bottom: 10px;
                    padding-left: 8px;
                ...
                ">
                    Monitor <span style="
                        ...
                        border-radius: 6px;
                        margin: 0 4px;
                    "><i class="fas fa-bolt" style="margin-right: 4px;"></i> Real-Time</span> dashboard for live updates
                </li>
                <li style="
                    margin-bottom: 0;
                    padding-left: 8px;
                ...
                ">
                    Use <span style="
                        ...
                        border-radius: 6px;
                        margin: 0 4px;
                    ">Quick Examples</span> for demonstration
                </li>
            </ul>
        </div>
    </div>
    ...
    ">
        ...
        <div style="max-width: 90%;">
            ...
            ">
                ...
                Professional Tips for Medication Safety
            </h3>
            ...
            ">
                ...
                ">
                    ...
                    ">
                        <div style="
                            ...
                            justify-content: center;
                        ">
                            <i class="fas fa-check-double" style="color: #10B981; font-size: 18px;"></i>
                        </div>
                        <h4 style="
                            color: #1F2937;
                            margin: 0;
                    ...
                    <p style="
                        ...
                        font-weight: 500;
                    ">
                        Always verify medication names before administration to prevent errors
                    </p>
                </div>
                ...
                ">
                    ...
                    ">
                        <div style="
                            ...
                            justify-content: center;
                        ">
                            <i class="fas fa-text-height" style="color: #8B5CF6; font-size: 18px;"></i>
                        </div>
                        <h4 style="
                            color: #1F2937;
                            margin: 0;
                    ...
                    <p style="
                        ...
                        font-weight: 500;
                    ">
                        Use Tall Man lettering (e.g., hydrALAZINE vs hydrOXYzine) for look-alike drugs
                    </p>
                </div>
                ...
                ">
                    ...
                    ">
                        <div style="
                            ...
                            justify-content: center;
                        ">
                            <i class="fas fa-file-medical-alt" style="color: #3B82F6; font-size: 18px;"></i>
                        </div>
                        <h4 style="
                            color: #1F2937;
                            margin: 0;
                    ...
                    <p style="
                        ...
                        font-weight: 500;
                    ">
                        Regularly consult FDA high-alert drug lists and safety communications
                    </p>
                </div>
                ...
                ">
                    ...
                    <p style="
                        ...
                        font-weight: 500;
                    ">
                        Report any confusion incidents through your institution's safety reporting system
                    </p>
                </div>
            </div>
            ...
            ">
                <p style="
                    ...
                    gap: 12px;
                ">
                    <i class="fas fa-info-circle" style="color: #8B5CF6; font-size: 18px; margin-top: 2px;"></i>
                    <span>Remember: This tool is designed to assist healthcare professionals but should not replace clinical judgment and verification.</span>
                </p>
            </div>
        </div>
    </div>
