"""
MediNomix AI - Backend API
FastAPI backend with real-time dashboard analytics
...
# Use simple password for student project
...
class RealTimeDashboardManager:
    """Manages real-time WebSocket connections for dashboard"""
...
def init_database():
    ...
    try:
        ...
        try:
            ...
            print("   Windows: Open Services (services.msc) and start PostgreSQL")
...
class OpenFDAClient:
    ...
    def extract_drug_data(fda_data: Dict, search_term: str) -> Optional[Dict]:
        ...
        try:
            ...
            # Use search_term to create unique ID
...
class RiskAnalyzer:
    """Simple risk analyzer without external dependencies"""
    ...
    def calculate_phonetic_similarity(name1: str, name2: str) -> float:
        ...
        # Check if they sound similar (simple version)
        sound_alike_pairs = [
            ("cef", "sef"), ("ph", "f"), ("x", "ks"),
            ("c", "k"), ("z", "s"), ("qu", "kw")
        ]
    ...
    def calculate_therapeutic_context_risk(drug1, drug2) -> float:
        ...
        # Check if purposes contain similar keywords
...
class DrugETL:
    ...
    async def fetch_and_store_drug(db: Session, search_term: str) -> Optional[Drug]:
        ...
        try:
            # First check if drug already exists in database
            ...
            for result in fda_results:
                # Pass search_term as second parameter
                ...
                if drug_data and drug_data["brand_name"]:
                    ...
                    # Analyze against existing drugs (in background)
    ...
    async def analyze_against_all_drugs(db: Session, new_drug: Drug):
        ...
        try:
            ...
            for other_drug in other_drugs:
                ...
                # Only proceed if there's some similarity
                if spelling < 20:
                    continue
...
async def get_dashboard_metrics(db: Session = Depends(get_db)):
    """Get dashboard metrics (HTTP endpoint)"""
...
async def search_and_analyze(
    ...
    try:
        ...
        if not drug:
            ...
            # Create a simple placeholder drug
            drug = Drug(
...
async def startup_event():
    ...
    print("\n" + "="*60)
    print("MediNomix AI - Starting Up...")
    print("="*60)
    ...
    print("\n💊 Example API Calls:")
    print("   • GET  /api/search/metformin")
    print("   • GET  /api/metrics")
    print("   • POST /api/seed-database")
    print("="*60)
    print("✅ MediNomix AI Backend is ready!")
    print("="*60 + "\n")
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("   - Windows: Open Services and start PostgreSQL")
        print("   - Linux/Mac: sudo systemctl start postgresql")
        print("\n2. Is port 8000 available?")
        print("   - Check: netstat -an | findstr :8000 (Windows)")
        print("   - Check: sudo lsof -i :8000 (Linux/Mac)")
        print("\n3. Try changing the port:")
        print("   - Change port=8000 to port=8001 in the code")