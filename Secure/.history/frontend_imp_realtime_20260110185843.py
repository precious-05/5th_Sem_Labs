...
.hero-section::before {{
    background-image: 
        ...
        radial-gradient(circle at 80% 20%, rgba(255, 255, 255, 0.1) 2px, transparent 3px),
        radial-gradient(circle at 40% 40%, rgba(255, 255, 255, 0.05) 1px, transparent 2px) !important;
    background-size: 100px 100px, 120px 120px, 80px 80px !important;
    background-position: 0 0, 60px 60px, 30px 30px !important;
}}
