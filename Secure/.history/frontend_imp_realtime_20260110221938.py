...
def create_heatmap_chart_seaborn():
    """Create heatmap using Seaborn for better annotation control"""
    ...
    colors = ["#F5F3FF", "#DDD6FE", "#8B5CF6", "#7C3AED", "#EC4899"]
    n_bins = 100
    cmap = LinearSegmentedColormap.from_list("purple_pink", colors, N=n_bins)
    ...
    ax.set_title('💊 Drug Confusion Risk Heatmap', 
                 fontsize=16, fontweight='bold', 
                 color='#1F2937', pad=20)
    ax.set_xlabel('Drug Names', fontsize=12, fontweight='bold', color='#374151')
    ax.set_ylabel('Drug Names', fontsize=12, fontweight='bold', color='#374151')
