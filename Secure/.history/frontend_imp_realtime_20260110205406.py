...
def create_risk_breakdown_chart():
    ...
    gradient_shades = [
        'linear-gradient(135deg, #EF4444 0%, #F87171 100%)',  # Critical gradient
        'linear-gradient(135deg, #F59E0B 0%, #FBBF24 100%)',  # High gradient
        'linear-gradient(135deg, #8B5CF6 0%, #A78BFA 100%)',  # Medium gradient
        'linear-gradient(135deg, #10B981 0%, #34D399 100%)'   # Low gradient
    ]
    ...
    fig = go.Figure(data=[go.Pie(
        ...
        marker=dict(
            ...
            pattern=dict(shape="", bgcolor="rgba(255,255,255,0.2)", solidity=0.3)
        ),
    ...
    fig.update_layout(
        ...
        annotations=[
            dict(
                ...
                x=0.5, y=0.5,
                font=dict(size=20, color=COLORS['text_primary'], family="Inter", weight=700),
                showarrow=False,
...
def create_top_risks_chart():
    ...
    fig = go.Figure(data=[
        go.Bar(
            ...
            marker=dict(
                ...
                gradient=dict(
                    type='vertical',
                    color=['rgba(255,255,255,0.8)', 'rgba(255,255,255,0.1)']
                ),
                pattern=dict(
                    shape="/",
                    size=2,
            ...
            hovertemplate="<b>%{x}</b><br>Risk Score: <b>%{y:.1f}%</b><br>Category: %{marker.color}<extra></extra>",
            hoverlabel=dict(
                bgcolor="white",
                font_size=12,
                font_family="Inter"
    ...
    fig.update_layout(
        ...
        yaxis=dict(
            ...
            linewidth=2,
            showgrid=True,
            range=[0, 105],  # Extend slightly above 100 for text
            tickmode='linear',
            dtick=20
        ),
        ...
        annotations=[
            dict(
                ...
                text=f"{yi:.1f}%",
                showarrow=False,
                font=dict(size=10, color=colors[i], family="Inter", weight=700),
                bgcolor="rgba(255, 255, 255, 0.9)",
                bordercolor=colors[i],
                borderwidth=1,
                borderpad=3,
                bordercornerradius=5
            ) for i, (xi, yi) in enumerate(zip(range(len(pairs)), scores))
        ]
    )
