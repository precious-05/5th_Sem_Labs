...
async def startup_event():
    ...
    if init_database():
        ...
        print(f"Database check: Has {db.query(Drug).count()} drugs, {db.query(ConfusionRisk).count()} risks")
    else:
    ...
    print("="*60)
    print("✅ MediNomix AI Backend v2.1 is ready!")
    print("="*60 + "\n")
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("3. Try changing the port to 8001")