...
COLORS = {
    "primary": "#B5F2EA",        # Seafoam
    "primary_light": "#D6FFF6",
    "primary_dark": "#8FD9D2",
    "secondary": "#C5E8FF",      # Sky Foam
    "accent": "#FFD6E0",         # Coral
    "accent_pink": "#FFC6D9",    # Seashell Pink
    "success": "#B5F2EA",        # Aqua Green
    "warning": "#FFE6B5",        # Sand
    "danger": "#FFB3BA",         # Coral Red
    "dark": "#5A7D7A",           # Deep Teal
    "light": "#F5FFFF",          # Ocean Mist
    "surface": "#F0FFFF",        # Azure
    "gray": "#C2D9D6",
    "gray_light": "#E6FFFF",
    "border": "#D4FFF6",
}
