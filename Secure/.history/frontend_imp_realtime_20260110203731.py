...
def render_analytics_tab():
    ...
    # Analytics Charts Section - Complete HTML in single markdown
    analytics_charts_html = """
    ...
    """
    st.markdown(analytics_charts_html, unsafe_allow_html=True)
    ...
    # Heatmap Section - Complete HTML in single markdown
    heatmap_html = """
    <div class="dashboard-section-card">
        <div class="section-header">
            <div class="section-icon">
    ...
    # FDA Alerts Section - Complete HTML in single markdown
    fda_html = """
    <div class="dashboard-section-card">
        <div class="section-header">
            <div class="section-icon">
    ...
    """
    st.markdown(fda_html, unsafe_allow_html=True)
    ...
    # Global CSS Styles - Sab style ek hi markdown mein
    st.markdown("""
    <style>
