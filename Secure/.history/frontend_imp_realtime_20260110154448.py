...
def main():
    ...
    with tab1:
        ...
        feature_images = [
            "https://img.freepik.com/premium-photo/3d-pharmacy-drug-health-pharmaceutical-purple-background-cartoon-minimal-first-aid-health-care-medical-symbol-emergency-help-3d-aid-medicine-icon-vector-render-illustration_839035-353279.jpg",
