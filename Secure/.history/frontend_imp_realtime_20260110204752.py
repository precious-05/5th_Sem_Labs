...
def create_top_risks_chart():
    """Create top risks chart - Professional version without emojis"""
    ...
    # Remove emojis from pairs and use clean formatting
    ...
    colors = [get_risk_color(score) for score in scores]
    ...
    fig.update_layout(
        ...
        xaxis=dict(
            ...
            range=[0, 105],  # Extend slightly beyond 100% for text visibility
            tickformat=',.0f'
        ),
    ...
    # Add risk level annotations with subtle styling
    for i, score in enumerate(scores):
        ...
        # Add subtle risk level annotation next to bar
        fig.add_annotation(
            x=score + 3,  # Position to the right of the bar
            y=i,
            text=risk_level,
            showarrow=False,
            font=dict(
