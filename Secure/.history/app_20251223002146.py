...
COLORS = {
    "primary": "#FF6B6B",        # Coral Fire se
    "primary_light": "#FF8E8E",
    "primary_dark": "#FF4757",
    "secondary": "#10B981",      # Emerald Forest se
    "accent": "#FFD93D",         # Citrus Burst se
    "accent_pink": "#D946EF",    # Fuchsia Pop se
    "success": "#10B981",        # Emerald
    "warning": "#FF9F43",        # Coral
    "danger": "#FF4757",         # Coral
    "dark": "#1F2937",           # Emerald
    "light": "#F0FDF4",          # Emerald
    "surface": "#FFFFFF",
    "gray": "#9CA3AF",
    "gray_light": "#F5F6FA",     # Coral
    "border": "#FFE8E8",         # Coral
}
