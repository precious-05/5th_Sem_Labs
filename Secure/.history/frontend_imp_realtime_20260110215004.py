...
def create_heatmap_chart():
    """Create interactive drug confusion heatmap with annotations - MODERN VERSION"""
    ...
    # Create annotations for high-risk cells - IMPROVED VERSION
    annotations = []
    for i, row in enumerate(risk_matrix):
        for j, value in enumerate(row):
            ...
            elif value > 50:  # Medium-high risk
                annotations.append(
                    dict(
                        x=j,
                        y=i,
                        text=f"<b>⚠️ {value:.0f}%</b>",
                        showarrow=False,
                        font=dict(
                            color="white", 
                            size=10, 
    ...
    # Modern purple gradient colorscale matching your theme
    colorscale = [
        [0.0, 'rgba(245, 243, 255, 0.9)'],      # Very light purple (low risk)
        [0.25, 'rgba(199, 210, 254, 0.9)'],     # Light purple-blue
        [0.5, 'rgba(139, 92, 246, 0.8)'],       # Primary purple
        [0.75, 'rgba(124, 58, 237, 0.85)'],     # Dark purple
        [1.0, 'rgba(236, 72, 153, 0.9)']        # Pink (high risk)
    ]
    
    # Alternative elegant colorscale (purple to pink gradient)
    elegant_colorscale = [
        [0.0, '#F5F3FF'],      # Very light purple
        [0.2, '#DDD6FE'],      # Light purple
        [0.4, '#8B5CF6'],      # Primary purple
        [0.6, '#7C3AED'],      # Dark purple
        [0.8, '#6D28D9'],      # Deeper purple
        [1.0, '#EC4899']       # Pink (high risk)
    ]
    ...
    # Update layout with modern glassmorphism theme
    fig.update_layout(
        title=dict(
        ...
        paper_bgcolor='rgba(245, 243, 255, 0.3)',  # Light purple glass effect
        ...
        margin=dict(l=90, r=80, t=90, b=100),
        ...
        # Add shape for glassmorphism border effect
        shapes=[
            dict(
                type="rect",
                xref="paper",
    ...
    # Add border for glassmorphism effect
    fig.update_xaxes(
        mirror=True,
        showline=True,
        linecolor=COLORS['border'],
