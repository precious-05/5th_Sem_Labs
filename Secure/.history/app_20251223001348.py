...
COLORS = {
    "primary": "#FFB7B2",        # Coral Peach
    "primary_light": "#FFD3BA",
    "primary_dark": "#FF8A7A",
    "secondary": "#FFDAC1",      # Light Peach
    "accent": "#E2F0CB",         # Soft Green
    "accent_pink": "#FF9AA2",    # Watermelon
    "success": "#C7F5D9",        # Pastel Green
    "warning": "#FFE5B4",        # Apricot
    "danger": "#FFB7C5",         # Rose
    "dark": "#7A6652",           # Warm Brown
    "light": "#FFF9F3",          # Cream
    "surface": "#FFF5E6",        # Peach Cream
    "gray": "#D9C6B0",
    "gray_light": "#FFEFE3",
    "border": "#FFD9C2",
}
