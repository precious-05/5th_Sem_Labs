...
def render_analytics_tab():
    ...
    st.markdown('</div>')  # Close dashboard-section-card
...
def render_sidebar():
    ...
    with st.sidebar:
        ...
        <div class="sidebar-main-card">
            ...
            <p class="sidebar-main-subtitle">AI Medication Safety</p>
        </div>
...
def main():
    ...
    # Navigation Tabs (AS IT WAS - NO ICONS)
    tab1, tab2, tab3, tab4 = st.tabs([" Home", " Drug Analysis", " Analytics", " Real-Time"])
    
    with tab1:
        render_hero_section()
        
        # Stats Counter with Font Awesome icons (EMOJI REPLACEMENT)
        col1, col2, col3, col4 = st.columns(4)
        render_stat_card("<i class='fas fa-users' style='color:#EC4899; font-size:24px;'></i>", "1.5M+", "Patients Protected", col1)
        render_stat_card("<i class='fas fa-dollar-sign' style='color:#10B981; font-size:24px;'></i>", "$42B", "Cost Saved", col2)
        render_stat_card("<i class='fas fa-bullseye' style='color:#8B5CF6; font-size:24px;'></i>", "99.8%", "Accuracy Rate", col3)
        render_stat_card("<i class='fas fa-pills' style='color:#7C3AED; font-size:24px;'></i>", "50K+", "Drugs Analyzed", col4)
        
        # Features Section with Images and Font Awesome icons (EMOJI REPLACEMENT)
        st.markdown("""
        <div style="margin: 40px 0;">
            <h2 style="text-align: center; margin-bottom: 32px; color: #111827; font-weight: 800;">
                <i class="fas fa-magic" style="color:#EC4899; margin-right:10px; font-size:28px;"></i>How MediNomix Works
            </h2>
        </div>
        """, unsafe_allow_html=True)
        ...
        features = [
            {"icon": "<i class='fas fa-search' style='color:#8B5CF6; font-size:24px;'></i>", "title": "Search Medication", "desc": "Enter any drug name to analyze potential confusion risks"},
            {"icon": "<i class='fas fa-brain' style='color:#EC4899; font-size:24px;'></i>", "title": "Analysis", "desc": "Our AI analyzes spelling, phonetic, and therapeutic similarities"},
            {"icon": "<i class='fas fa-shield-alt' style='color:#10B981; font-size:24px;'></i>", "title": "Risk Prevention", "desc": "Get detailed risk assessments and prevention recommendations"}
        ]
        ...
        # Trust Section with Images (EMOJI REPLACEMENT)
        render_glass_card("<i class='fas fa-handshake' style='color:#8B5CF6; margin-right:10px; font-size:24px;'></i>Trusted by Healthcare Professionals")
        
        # Medical images grid with icon overlays (EMOJI REPLACEMENT)
        medical_images = [
        ...
        medical_icons = [
            "<i class='fas fa-user-md' style='color:#8B5CF6; font-size:18px;'></i> Expert Doctors",
            "<i class='fas fa-users' style='color:#EC4899; font-size:18px;'></i> Team Collaboration",
            "<i class='fas fa-hospital' style='color:#10B981; font-size:18px;'></i> Modern Facilities",
            "<i class='fas fa-hand-holding-heart' style='color:#7C3AED; font-size:18px;'></i> Compassionate Care"
        ]
    ...
    # Render Footer with beautiful icons (EMOJI REPLACEMENT)
    st.markdown(f"""
    <div class="neon-footer">
        <div style="max-width: 600px; margin: 0 auto; padding: 0 20px;">
            <div style="margin-bottom: 24px;">
                <div style="font-size: 48px; margin-bottom: 12px;">
                    <i class="fas fa-heartbeat" style="color:white; text-shadow: 0 0 20px rgba(255,255,255,0.5);"></i>
                </div>
                <h3 style="color: white !important; margin-bottom: 8px; font-weight: 700;">
                    <i class="fas fa-capsules" style="margin-right:10px; font-size:24px;"></i>MediNomix
                </h3>
                <p style="color: rgba(255, 255, 255, 0.95) !important; font-size: 14px; max-width: 500px; margin: 0 auto;">
                    <i class="fas fa-shield-alt" style="margin-right:8px;"></i>Preventing medication errors with artificial intelligence
                </p>
            </div>
            ...
            <div style="display: flex; justify-content: center; gap: 20px; margin: 20px 0;">
                <div style="text-align: center;">
                    ...
                    <div style="color:white; font-size:12px; margin-top:5px;">Verified</div>
                </div>
                <div style="text-align: center;">
                    <i class="fas fa-lock" style="color:#38BDF8; font-size:24px;"></i>
                    <div style="color:white; font-size:12px; margin-top:5px;">Secure</div>
                </div>
                <div style="text-align: center;">
                    <i class="fas fa-clock" style="color:#FBBF24; font-size:24px;"></i>
                    <div style="color:white; font-size:12px; margin-top:5px;">24/7</div>
                </div>
            </div>
            
            <div style="border-top: 1px solid rgba(255, 255, 255, 0.2); padding-top: 20px; color: rgba(255, 255, 255, 0.8) !important; font-size: 12px;">
                <div style="margin-bottom: 8px; font-weight: 600;">
                    <i class="far fa-copyright" style="margin-right:5px;"></i>2024 MediNomix. All rights reserved.
                </div>
                <div>
