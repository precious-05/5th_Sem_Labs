...
def get_icon_svg(icon_name, color="#4361ee", size=24):
    ...
    icon_map = {
        ...
        "info": f"""<svg xmlns="http://www.w3.org/2000/svg" width="{size}" height="{size}" viewBox="0 0 24 24" fill="none" stroke="{color}" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg>""",
        "stats": f"""<svg xmlns="http://www.w3.org/2000/svg" width="{size}" height="{size}" viewBox="0 0 24 24" fill="none" stroke="{color}" stroke-width="2"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg>""",
        "heartbeat": f"""<svg xmlns="http://www.w3.org/2000/svg" width="{size}" height="{size}" viewBox="0 0 24 24" fill="none" stroke="{color}" stroke-width="2"><path d="M22 17H2l4-8 5 5 7-7"/><path d="M2 12h6"/><path d="M16 12h6"/></svg>""",
        "capsules": f"""<svg xmlns="http://www.w3.org/2000/svg" width="{size}" height="{size}" viewBox="0 0 24 24" fill="none" stroke="{color}" stroke-width="2"><path d="M10 2v6"/><path d="M14 2v6"/><path d="M16 8a4 4 0 0 1-8 0"/><rect x="4" y="10" width="16" height="10" rx="2"/></svg>""",
        ...
        "bell": f"""<svg xmlns="http://www.w3.org/2000/svg" width="{size}" height="{size}" viewBox="0 0 24 24" fill="none" stroke="{color}" stroke-width="2"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/></svg>""",
        "check": f"""<svg xmlns="http://www.w3.org/2000/svg" width="{size}" height="{size}" viewBox="0 0 24 24" fill="none" stroke="{color}" stroke-width="2"><path d="M20 6 9 17l-5-5"/></svg>""",
        "chevron-right": f"""<svg xmlns="http://www.w3.org/2000/svg" width="{size}" height="{size}" viewBox="0 0 24 24" fill="none" stroke="{color}" stroke-width="2"><polyline points="9 18 15 12 9 6"/></svg>""",
        "filter": f"""<svg xmlns="http://www.w3.org/2000/svg" width="{size}" height="{size}" viewBox="0 0 24 24" fill="none" stroke="{color}" stroke-width="2"><polygon points="22 3 2 3 10 12.46 10 19 14 21 14 12.46 22 3"/></svg>""",
        "eye": f"""<svg xmlns="http://www.w3.org/2000/svg" width="{size}" height="{size}" viewBox="0 0 24 24" fill="none" stroke="{color}" stroke-width="2"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>""",
        "download": f"""<svg xmlns="http://www.w3.org/2000/svg" width="{size}" height="{size}" viewBox="0 0 24 24" fill="none" stroke="{color}" stroke-width="2"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>""",
        "trash": f"""<svg xmlns="http://www.w3.org/2000/svg" width="{size}" height="{size}" viewBox="0 0 24 24" fill="none" stroke="{color}" stroke-width="2"><path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/><line x1="10" y1="11" x2="10" y2="17"/><line x1="14" y1="11" x2="14" y2="17"/></svg>""",
        "lightbulb": f"""<svg xmlns="http://www.w3.org/2000/svg" width="{size}" height="{size}" viewBox="0 0 24 24" fill="none" stroke="{color}" stroke-width="2"><path d="M15 14c.2-1 .7-1.7 1.5-2.5 1-.9 1.5-2.2 1.5-3.5A6 6 0 0 0 6 8c0 1 .2 2.2 1.5 3.5.7.7 1.3 1.5 1.5 2.5"/><path d="M9 18h6"/><path d="M10 22h4"/></svg>""",
        ...
        "users": f"""<svg xmlns="http://www.w3.org/2000/svg" width="{size}" height="{size}" viewBox="0 0 24 24" fill="none" stroke="{color}" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>""",
        "clock": f"""<svg xmlns="http://www.w3.org/2000/svg" width="{size}" height="{size}" viewBox="0 0 24 24" fill="none" stroke="{color}" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>""",
        "server": f"""<svg xmlns="http://www.w3.org/2000/svg" width="{size}" height="{size}" viewBox="0 0 24 24" fill="none" stroke="{color}" stroke-width="2"><rect x="2" y="2" width="20" height="8" rx="2" ry="2"/><rect x="2" y="14" width="20" height="8" rx="2" ry="2"/><line x1="6" y1="6" x2="6.01" y2="6"/><line x1="6" y1="18" x2="6.01" y2="18"/></svg>""",
        "tools": f"""<svg xmlns="http://www.w3.org/2000/svg" width="{size}" height="{size}" viewBox="0 0 24 24" fill="none" stroke="{color}" stroke-width="2"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/></svg>""",
        ...
        "chevron-up": f"""<svg xmlns="http://www.w3.org/2000/svg" width="{size}" height="{size}" viewBox="0 0 24 24" fill="none" stroke="{color}" stroke-width="2"><polyline points="18 15 12 9 6 15"/></svg>""",
        ...
        "flask": f"""<svg xmlns="http://www.w3.org/2000/svg" width="{size}" height="{size}" viewBox="0 0 24 24" fill="none" stroke="{color}" stroke-width="2"><path d="M10 2v6"/><path d="M14 2v6"/><path d="M16 8a4 4 0 0 1-8 0"/><path d="M5 10h14l1 10H4L5 10z"/></svg>""",
        "wave-square": f"""<svg xmlns="http://www.w3.org/2000/svg" width="{size}" height="{size}" viewBox="0 0 24 24" fill="none" stroke="{color}" stroke-width="2"><path d="M2 12h4v8H2z"/><path d="M10 4h4v16h-4z"/><path d="M18 8h4v12h-4z"/></svg>""",
        "stethoscope": f"""<svg xmlns="http://www.w3.org/2000/svg" width="{size}" height="{size}" viewBox="0 0 24 24" fill="none" stroke="{color}" stroke-width="2"><path d="M4.5 3h15v5a7.5 7.5 0 0 1-7.5 7.5A7.5 7.5 0 0 1 4.5 8V3z"/><path d="M8.5 18a4.5 4.5 0 1 0 9 0v-3"/><circle cx="18" cy="11" r="2"/></svg>""",
        "tachometer": f"""<svg xmlns="http://www.w3.org/2000/svg" width="{size}" height="{size}" viewBox="0 0 24 24" fill="none" stroke="{color}" stroke-width="2"><path d="M12 2v10"/><path d="m19.07 19.07-1.41-1.41"/><path d="M5 12a7 7 0 1 0 14 0"/><circle cx="12" cy="12" r="3"/></svg>""",
        "industry": f"""<svg xmlns="http://www.w3.org/2000/svg" width="{size}" height="{size}" viewBox="0 0 24 24" fill="none" stroke="{color}" stroke-width="2"><path d="M12 22V8"/><path d="M2 12h4l2-4 2 4h4l2-4 2 4h4l2-4 2 4h4"/><rect x="2" y="16" width="20" height="6" rx="2"/></svg>""",
        ...
        "bolt": f"""<svg xmlns="http://www.w3.org/2000/svg" width="{size}" height="{size}" viewBox="0 0 24 24" fill="none" stroke="{color}" stroke-width="2"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="12.5 22 12.5 12 20 8"/><polyline points="11.5 2 11.5 12 4 8"/></svg>""",
        "dollar": f"""<svg xmlns="http://www.w3.org/2000/svg" width="{size}" height="{size}" viewBox="0 0 24 24" fill="none" stroke="{color}" stroke-width="2"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>""",
        ...
        "vial": f"""<svg xmlns="http://www.w3.org/2000/svg" width="{size}" height="{size}" viewBox="0 0 24 24" fill="none" stroke="{color}" stroke-width="2"><path d="M8 2v4"/><path d="M16 2v4"/><rect x="4" y="6" width="16" height="16" rx="2"/><path d="M9 13h6"/></svg>""",
        ...
        "exclamation": f"""<svg xmlns="http://www.w3.org/2000/svg" width="{size}" height="{size}" viewBox="0 0 24 24" fill="none" stroke="{color}" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>""",
        ...
        "spell-check": f"""<svg xmlns="http://www.w3.org/2000/svg" width="{size}" height="{size}" viewBox="0 0 24 24" fill="none" stroke="{color}" stroke-width="2"><path d="m6 16 6-12 6 12"/><path d="M8 12h8"/><path d="M4 21c1.1 0 1.1-1 2.3-1s1.1 1 2.3 1c1.1 0 1.1-1 2.3-1 1.1 0 1.1 1 2.3 1c1.1 0 1.1-1 2.3-1 1.1 0 1.1 1 2.3 1 1.1 0 1.1-1 2.3-1"/></svg>""",
        "thermometer": f"""<svg xmlns="http://www.w3.org/2000/svg" width="{size}" height="{size}" viewBox="0 0 24 24" fill="none" stroke="{color}" stroke-width="2"><path d="M14 4v10.54a4 4 0 1 1-4 0V4a2 2 0 0 1 4 0z"/></svg>""",
    }
...
# Main Header Section - FIXED: Using Streamlit components instead of HTML
st.markdown("""
<div style='text-align: center; padding: 3rem 0 2rem 0; position: relative;'>
    <div style='position: absolute; top: 50px; left: 10%; width: 100px; height: 100px; 
         background: linear-gradient(135deg, #4361ee20, #7209b720); border-radius: 50%; 
...
# Action Buttons Section - FIXED: Using Streamlit components
st.markdown("""
...
with tab1:
    ...
    with col2:
        st.image(get_icon_svg("search", COLORS["primary"], 80))
        st.markdown('<h2 class="section-header">Drug Confusion Risk Analysis</h2>', unsafe_allow_html=True)
        st.markdown(f'<p style="color: {COLORS["gray"]}; font-size: 1.2rem; text-align: center; line-height: 1.6;">Enter a drug name to analyze potential confusion risks with similar medications using advanced AI algorithms</p>', unsafe_allow_html=True)
...
with tab2:
    # Dashboard
    st.image(get_icon_svg("dashboard", COLORS["primary"], 80))
    st.markdown('<h2 class="section-header">Medication Safety Analytics</h2>', unsafe_allow_html=True)
    st.markdown(f'<p style="color: {COLORS["gray"]}; font-size: 1.2rem; text-align: center; line-height: 1.6;">Real-time insights into drug confusion risks and safety patterns using advanced AI analytics</p>', unsafe_allow_html=True)
...
with tab3:
    # About Section
    st.image(get_icon_svg("hospital", COLORS["primary"], 80))
    st.markdown('<h2 class="section-header">About MediNomix</h2>', unsafe_allow_html=True)
    st.markdown(f'<p style="color: {COLORS["gray"]}; font-size: 1.2rem; text-align: center; line-height: 1.6; max-width: 700px; margin: 0 auto;">A next-generation healthcare safety platform designed to prevent medication errors through advanced AI analysis and real-time monitoring</p>', unsafe_allow_html=True)
...
# Footer Section - FIXED: Using Streamlit components
st.markdown('<div class="medinomix-footer"></div>', unsafe_allow_html=True)

# Footer content using Streamlit
...
with footer_cols[1]:
    ...
    <div style='margin: 25px 0;'>
        <div style='font-size: 1.1rem; color: {COLORS["dark"]}; font-weight: 700; margin-bottom: 10px; text-align: center;'>
            © 2024 MediNomix • Version 3.0 • Advanced Medication Safety Platform
        </div>
        <div style='display: flex; justify-content: center; gap: 20px; margin-top: 20px;'>
            <a href='https://github.com/precious-05/MediNomix' target='_blank' style='color: {COLORS["primary"]}; text-decoration: none; font-weight: 600; display: flex; align-items: center;'>
                <img src='{get_icon_svg("book", COLORS["primary"], 20)}' style='width: 20px; height: 20px; margin-right: 8px;'>
                GitHub
            </a>
            <a href='https://github.com/precious-05/MediNomix/issues' target='_blank' style='color: {COLORS["primary"]}; text-decoration: none; font-weight: 600; display: flex; align-items: center;'>
                <img src='{get_icon_svg("bug", COLORS["primary"], 20)}' style='width: 20px; height: 20px; margin-right: 8px;'>
                Report Bug
            </a>
            <a href='https://github.com/precious-05/MediNomix' target='_blank' style='color: {COLORS["primary"]}; text-decoration: none; font-weight: 600; display: flex; align-items: center;'>
                <img src='{get_icon_svg("book-medical", COLORS["primary"], 20)}' style='width: 20px; height: 20px; margin-right: 8px;'>
                Documentation
            </a>
        </div>
    </div>
    ...
    <div style='margin-top: 30px; padding-top: 25px; border-top: 1px solid rgba(67, 97, 238, 0.1);'>
        <div style='font-size: 0.9rem; color: {COLORS["gray"]}; font-style: italic; max-width: 800px; margin: 0 auto; line-height: 1.6; display: flex; align-items: flex-start;'>
            <img src='{get_icon_svg("alert", COLORS["warning"], 20)}' style='width: 20px; height: 20px; margin-right: 10px; margin-top: 2px;'>
