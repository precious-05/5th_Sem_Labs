...
COLORS = {
    ...
    "accent_pink": "#8B5CF6",    # Light Purple (pink ki jagah)
    "success": "#10B981",        # Emerald
    "warning": "#FF9F43",        # Coral Orange
    "danger": "#EF4444",         # Neutral Red
    "dark": "#1E1B4B",           # Dark Purple
    "light": "#FAF5FF",          # Purple Tint White
    "surface": "#FFFFFF",
    "gray": "#A78BFA",           # Light Purple Gray
    "gray_light": "#F5F3FF",     # Very Light Purple
