...
# Premium Aurora Gradient Color Scheme
COLORS = {
    'primary': '#7C3AED',          # Purple
    'primary_hover': '#6D28D9',    # Darker Purple
    'secondary': '#EC4899',        # Pink
    'tertiary': '#38BDF8',         # Blue
    'success': '#10B981',
    'warning': '#F59E0B',
    'danger': '#EF4444',
    'info': '#38BDF8',             # Blue
    ...
    'yellow': '#FBBF24',
    'pink': '#EC4899',             # Pink
    'dark': '#0F172A',             # Darker for contrast
    'light': '#FFFFFF',
    'card_bg': '#FFFFFF',
    'sidebar_bg': '#F8FAFC',
    'border': '#E2E8F0',
    ...
    'text_muted': '#64748B',
    'shadow': 'rgba(124, 58, 237, 0.15)',      # Purple shadow
    'shadow_hover': 'rgba(124, 58, 237, 0.25)', # Purple shadow hover
    'gradient_primary': 'linear-gradient(135deg, #7C3AED 0%, #EC4899 50%, #38BDF8 100%)',  # Purple → Pink → Blue
    'gradient_secondary': 'linear-gradient(135deg, #EC4899 0%, #7C3AED 100%)',  # Pink → Purple
    ...
    'gradient_purple': 'linear-gradient(135deg, #7C3AED 0%, #A78BFA 100%)',  # Purple gradient
    'gradient_pink': 'linear-gradient(135deg, #EC4899 0%, #F472B6 100%)',    # Pink gradient
    'gradient_blue': 'linear-gradient(135deg, #38BDF8 0%, #60A5FA 100%)',    # Blue gradient
    'gradient_dark': 'linear-gradient(135deg, #0F172A 0%, #1E293B 100%)',
    'gradient_aurora': 'linear-gradient(135deg, #7C3AED 0%, #EC4899 50%, #38BDF8 100%)',  # Full Aurora
    'gradient_medical': 'linear-gradient(135deg, #7C3AED 0%, #EC4899 50%, #38BDF8 100%)'  # Updated medical gradient
}
# ================================
